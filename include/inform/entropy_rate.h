 ...
 */
double inform_entropy_rate(uint64_t const *series, size_t n, size_t m,
 ...
 */
int inform_local_entropy_rate(uint64_t const *series, size_t n, size_t m,
    uint64_t b, uint64_t k, double *er);
